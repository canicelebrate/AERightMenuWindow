#
#  Be sure to run `pod spec lint AERightMenuWindow.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "AERightMenuWindow"
  s.version      = "0.0.2"
  s.summary      = "A generic approach to show view controller as side right menu in iOS"
...
Also, you can set the dropback color(normally it's a semi-transparent color) and the animation duration for showing the side menu.
  ...
  s.homepage     = "https://github.com/canicelebrate/AERightMenuWindow"
  ...
  s.source       = { :git => "https://github.com/canicelebrate/AERightMenuWindow.git", :tag => s.version }
  ...
  s.source_files  = "RightMenuCore/*.{h,m}"
#s.exclude_files = "Classes/Exclude"

  # s.public_header_files = "RightMenuCore/*.h"
